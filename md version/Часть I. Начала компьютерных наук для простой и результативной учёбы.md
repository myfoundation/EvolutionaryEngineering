...
+-----------------------------------------------------------------------+
| Вход (Индекс/Токен) ---> [ ТАБЛИЦА АДРЕСОВ / КОМАНД ROM ]             |
...
Транслируем таблицу МТ из предыдущего примера в машинный код (блочно-линейную таблицу диспетчеризации с последовательным перебором) и выполним его на доменной VM.  
