var SQLike ={q:function SQLike_q(obj){
		"use strict";
		...
		if(d && typeof d=="object" && !d.push){
			o2={TESTSUB:true};
			for(i in d){o2[i]=d[i]};
			if(SQLike_q(o2)=="issub"){d=SQLike_q(d)}
		};
		...
		if(o.INTO && o.INTO.push){
			intoAr=o.INTO;
			o.INTO=uu;
			intoAr.splice.apply(intoAr,[intoAr.length,0].concat(SQLike_q(o)));
			return intoAr
		};
		...
		if(setop){
			...
			return setopFuncHolder.f(o,SQLike_q)
		};
