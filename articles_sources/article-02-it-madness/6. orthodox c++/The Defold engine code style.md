---
created: 2026-08-21T22:29:08 (UTC +03:00)
tags: [defold,gameengine,game-engine,game-development,game-dev,gamedev,open-source,opensource,crossplatform,cross-platform,free,nintendo-switch,console,html5,web,android,ios,desktop]
source: https://defold.com/2020/05/31/The-Defold-engine-code-style/
...
> ## Excerpt
> Since we opened up our source code to contributors, we also get some questions from time to time regarding our choice of coding conventions. These are some of our expe...
...
## Background[](https://defold.com/2020/05/31/The-Defold-engine-code-style/#background)
...
## A “modern” engine[](https://defold.com/2020/05/31/The-Defold-engine-code-style/#a-modern-engine)
...
### C++ patterns[](https://defold.com/2020/05/31/The-Defold-engine-code-style/#c-patterns)
...
### Standard Template Library (`std::`)[](https://defold.com/2020/05/31/The-Defold-engine-code-style/#standard-template-library-std)
...
### Shipping time![](https://defold.com/2020/05/31/The-Defold-engine-code-style/#shipping-time)
...
## The Defold engine[](https://defold.com/2020/05/31/The-Defold-engine-code-style/#the-defold-engine)
...
### Small codebase, small engine[](https://defold.com/2020/05/31/The-Defold-engine-code-style/#small-codebase-small-engine)
...
### C-like C++[](https://defold.com/2020/05/31/The-Defold-engine-code-style/#c-like-c)
...
### No classes[](https://defold.com/2020/05/31/The-Defold-engine-code-style/#no-classes)
...
### No exceptions[](https://defold.com/2020/05/31/The-Defold-engine-code-style/#no-exceptions)
...
### No STL[](https://defold.com/2020/05/31/The-Defold-engine-code-style/#no-stl)
...
### Containers[](https://defold.com/2020/05/31/The-Defold-engine-code-style/#containers)
...
### Pointers[](https://defold.com/2020/05/31/The-Defold-engine-code-style/#pointers)
...
#### Pointer alternatives[](https://defold.com/2020/05/31/The-Defold-engine-code-style/#pointer-alternatives)
...
-   Unique pointers are another pattern, and in fact, a bit more inline with the RAII we sometimes use. However, we _would_ only need them in short scopes, thus it’s just as easy to deallocate the pointer manually. Manual deallocation also helps with readability.
    

### Data life time[](https://defold.com/2020/05/31/The-Defold-engine-code-style/#data-life-time)
...
### Modern C++[](https://defold.com/2020/05/31/The-Defold-engine-code-style/#modern-c)
...
Nowadays, there are more and more features being pumped into the C++ language, and an honest question is: “Who is it for?”. I haven’t seen any new feature that would make this engine (or any code that I’ve written for the last 10 years) significantly better. Convenient perhaps, but not better in terms of compile time, code size and runtime or readability. As such, we’ll just stick to the proven way that we’ve been on for the last 11 years.

We are still using the feature set of `-std=c++98` for the engine code, and although I’d like to enforce it in the compiler flags, some platforms require us to use `-std=c++11`. So it’s just easier to leave the compiler flags at its default, and just stay clear of the recent features of the language. If there was a way to set the standard to “C-like C++”, it would be great.
...
## Final thoughts[](https://defold.com/2020/05/31/The-Defold-engine-code-style/#final-thoughts)
...
If you want to learn more about our contribution process and how to help out then please [head over to our Contribution page](https://defold.com/contribute/).
